...
<aside class="Hui-aside">
	<div class="menu_dropdown bk_2">
		<dl id="menu-article">
			<dt><i class="Hui-iconfont">&#xe616;</i> 运动员信息<i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i></dt>
			<dd>
				<ul>
					<li><a data-href="{{ route('userindex') }}" data-title="运动员列表" href="javascript:void(0)">运动员列表</a></li>
					<li><a data-href="{{ route('user_add') }}" data-title="添加运动员" href="javascript:void(0)">添加运动员</a></li>
			</ul>
		</dd>
	</dl>
		<dl id="menu-picture">
		...
		<dl id="menu-product">
			...
			<dd>
				<ul>
					...
					<li><a data-href="{{route('dataadd')}}" data-title="比赛数据添加" href="javascript:void(0)">比赛数据添加</a></li>
		...
		<dl id="menu-tongji">
			<dt><i class="Hui-iconfont">&#xe61a;</i> 比赛数据统计<i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i></dt>
			<dd>
				<ul>
